...
fun groupDetail(groupId: String, groupMember: List<Any>, session: String): Any {
    ...
    val groupMember = listOf("Galung Wendi Wijaya", "oktariza dwi putri", "elrida eldaa","reza yahya pahlevi","messy w","andre","kukuh","hary")
 ...
 */
fun myTeam(): List<Any> {
    val groupMember = listOf("oktariza dwi putri", "elrida eldaa","reza yahya pahlevi","messy Wirdianti","galung wendi wijaya")
    val namaku = groupMember [4]
    println("Nama Saya : $namaku")
    return groupMember
}
